package com.manoffocus.mfcomponentsnav.components.mflabel
...
import com.manoffocus.mfcomponentsnav.databinding.MfLabelBinding
...
class MFLabel : ConstraintLayout {
    ...
    val linkTypeFace by lazy {
        ResourcesCompat.getFont(context, R.font.ailerons) ?: throw RuntimeException("ailerons font not found")
    }
    ...
    private fun loadAttrs(attrs: AttributeSet?) {
        context.theme.obtainStyledAttributes(
            ...
            mfLabelColor = getInteger(R.styleable.MFLabel_mf_label_color, -1)
