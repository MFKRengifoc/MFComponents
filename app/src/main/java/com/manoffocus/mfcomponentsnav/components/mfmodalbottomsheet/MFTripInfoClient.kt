 ...
 * Use the [MFTripInfoClient.newInstance] factory method to
 * create an instance of this fragment.
 */
class MFTripInfoClient : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        model?.let { m ->
            ...
            binding.mfTripInfoOriginDataChip.externalSetChipTitleText(getString(R.string.mf_trip_info_booking_client_origin_label))
            binding.mfTripInfoOriginDataChip.externalSetChipValueText(m.originName)
            binding.mfTripInfoDestinationDataChip.externalSetChipTitleText(getString(R.string.mf_trip_info_booking_client_destination_label))
